        ...
        return (
          <Form
            ...
            <TextInput
              ...
              placeholder={
                step === 1
                  ? t('content.login.form.labels.xtressId')
                  : t('content.login.form.labels.password')
              }
              onBlur={handleBlur}
              invalid={
                step === 1
                  ? errors.xtressId && attemptedSubmit
                  : errors.password && attemptedSubmit
              }
              onChange={handleChange}
              value={step === 1 ? values.xtressId : values.password}
